...
const About = () => {
  return (
    <div className="hero lg:h-[500px]  my-24">
      <div className="hero-content flex-col gap-5 lg:flex-row">
        <div className='lg:w-1/2 relative'>

        <img
          src={person}
          className="w-3/4 lg:h-[500px] object-cover rounded-lg shadow-2xl"
        />
        <img
          src={parts}
          className="w-1/2 lg:h-[300px] object-cover border-[10px] border-white absolute right-5 top-1/2 rounded-lg shadow-2xl"
        />
        </div>
        <div className='lg:w-1/2 mt-10 lg:mt-0'>
          <h1 className="text-[#FF3811] font-inter font-semibold py-3">About Us</h1>
          <h1 className="lg:text-5xl text-3xl font-semibold max-w-sm leading-[54px] font-inter">We are qualified & of experience in this field</h1>
          <p className="font-inter  text-[#737373] py-5">
